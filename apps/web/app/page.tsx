import AdaptiveTutor from "@/components/adaptive-tutor";
    ...
    <main className="flex flex-1 flex-col items-center px-4 py-8 sm:py-12">
      <header className="mb-8 w-full max-w-5xl">
        ...
        <p className="mt-2 max-w-2xl text-black/60">
          An adaptive tutor that remembers mistakes, diagnoses
          misconceptions, updates mastery, and schedules the next review.
        </p>
      </header>
